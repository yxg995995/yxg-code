...
class Ui_in_detailWindow(object):
    
    def setupUi(self, in_detailWindow):
        in_detailWindow.setObjectName("in_detailWindow")
        in_detailWindow.resize(622, 504)
        
        self.centralwidget = QtWidgets.QWidget(in_detailWindow)
        ...
        in_detailWindow.setCentralWidget(self.centralwidget)
        
        self.menubar = QtWidgets.QMenuBar(in_detailWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 622, 23))
        self.menubar.setObjectName("menubar")
        self.menu = QtWidgets.QMenu(self.menubar)
        self.menu.setObjectName("menu")
        in_detailWindow.setMenuBar(self.menubar)
        self.actionadd = QtWidgets.QAction(in_detailWindow)
        self.actionadd.setObjectName("actionadd")
        self.actiondelete = QtWidgets.QAction(in_detailWindow)
        self.actiondelete.setObjectName("actiondelete")
        
        self.menu.addSeparator()
        self.menu.addAction(self.actionadd)
        self.menu.addAction(self.actiondelete)
        self.help= QtWidgets.QAction(in_detailWindow)
        self.help.setObjectName("help")
        self.menu.addAction(self.help)
        self.menubar.addAction(self.menu.menuAction())

        self.retranslateUi(in_detailWindow)
        self.clear.clicked.connect(self.search_line.clear)
        QtCore.QMetaObject.connectSlotsByName(in_detailWindow)
        in_detailWindow.setTabOrder(self.switch_line, self.switchPageButton)
        in_detailWindow.setTabOrder(self.switchPageButton, self.search_line)
        in_detailWindow.setTabOrder(self.search_line, self.feature)
        in_detailWindow.setTabOrder(self.feature, self.searchButton)
        in_detailWindow.setTabOrder(self.searchButton, self.clear)
        in_detailWindow.setTabOrder(self.clear, self.prevButton)
        in_detailWindow.setTabOrder(self.prevButton, self.nextButton)
    ...
    def onSearch(self):
        ...
        q="select * from info_detail where "+feature+" like %s"
        query=(q%key)
    ...
    def getTotalRecord(self):
        self.queryModel.setQuery("select * from info_detail")
    ...
    def setTableView(self):
        ...
        self.queryModel.setHeaderData(0, Qt.Horizontal, "入库单编号")
        self.queryModel.setHeaderData(1, Qt.Horizontal, "产品编号")
        self.queryModel.setHeaderData(2, Qt.Horizontal, "入库数量")
        self.queryModel.setHeaderData(3, Qt.Horizontal, "所花成本")
        
    def recordQuery(self,limitIndex):
        szQuery = ("select * from info_detail limit %s,%s" %(limitIndex , self.PageRecordCount))

    def retranslateUi(self, in_detailWindow):
        
        _translate = QtCore.QCoreApplication.translate
        in_detailWindow.setWindowTitle(_translate("in_detailWindow", "入库明细表"))
        self.prevButton.setText(_translate("in_detailWindow", "前一页"))
        self.nextButton.setText(_translate("in_detailWindow", "后一页"))
        self.label.setText(_translate("in_detailWindow", "前往"))
        self.label_2.setText(_translate("in_detailWindow", "页"))
        
        self.switchPageButton.setText(_translate("in_detailWindow", "go"))
        self.feature.setItemText(0, _translate("in_detailWindow", "info_orderNo"))
        self.feature.setItemText(1, _translate("in_detailWindow", "product_in_id"))
        self.feature.setItemText(2, _translate("in_detailWindow", "quantity"))
        self.feature.setItemText(3, _translate("in_detailWindow", "cost"))
        
        self.searchButton.setText(_translate("in_detailWindow", "搜索"))
        self.clear.setText(_translate("in_detailWindow", "更新"))
        
        self.menu.setTitle(_translate("in_detailWindow", "功能"))
        self.actionadd.setText(_translate("in_detailWindow", "add"))
        self.actionadd.setShortcut(_translate("in_detailWindow", "Ctrl+N"))
        self.actiondelete.setText(_translate("in_detailWindow", "delete"))
        self.help.setText(_translate("in_detailWindow", "help"))
